...
os.environ["WANDB_NAME"] = "v35a-grpo-narrow-on-v34"
os.environ["WANDB_RUN_ID"] = "v35a-grpo-narrow"  # consistent ID for resume
...
ADAPTER_V22 = os.path.join(WORKSPACE, "output_v34", "nemotron-lora-adapter")  # v35a uses v34 SFT as base
DATA_PATH = os.path.join(WORKSPACE, "data", "grpo_goldilocks.jsonl")
OUTPUT_DIR = os.path.join(WORKSPACE, "output_v35a")
...
# v35a: load v34 SFT adapter as the base for narrow GRPO
print(f"Loading v34 SFT adapter from {ADAPTER_V22} ...")
...
print(f"v35a NARROW 2-reward registered: {[f.__name__ for f in ALL_REWARDS]}")
print(f"Lesson from v33: 7 rewards collapsed into 0.54 because most rewards never fired.")
print(f"v35a hypothesis: GRPO on v34 SFT (which now teaches per-bit work) only needs to reinforce CORRECTNESS.")
