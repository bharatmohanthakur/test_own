"""
CPU-only submission wrapper for v30 SFT adapter.
- Takes Kaggle dataset bharatmohan/nemotron-v30-sft-mixed-adapter as input
...
candidates = []
for pat in [
    "/kaggle/input/nemotron-v30-sft-mixed-adapter",
    "/kaggle/input/datasets/bharatmohan/nemotron-v30-sft-mixed-adapter",
    "/kaggle/input/*/nemotron-v30-sft-mixed-adapter",
    "/kaggle/input/*",
    "/kaggle/input/*/*",
]:
