...
try:
    ...
    try:
        ...
        wandb.init(project="nemotron-reasoning", name="sft-v34-binary-rebuild",
...
jsonl_paths = []
for pat in [
    "/kaggle/input/nemotron-training-v34/training_v34.jsonl",
    "/kaggle/input/datasets/bharatmohan/nemotron-training-v34/training_v34.jsonl",
    "/kaggle/input/*/training_v34.jsonl",
    "/kaggle/input/*/*/training_v34.jsonl",
    "/kaggle/input/*/*/*/training_v34.jsonl",
]:
...
if jsonl_paths:
    ...
    print("ERROR: training_v34.jsonl NOT FOUND")
    sys.exit(1)
...
print(f"\n{'='*60}")
print(f"SFT v34 — v22 base + 150 new binary examples (569 total) + Unsloth + 3 epochs")
print(f"{'='*60}")
