"""
SFT v22 — v7's EXACT 504 examples + Unsloth speed
v7 scored 0.69 with: 504 verified, alpha=64, LR=2e-4, 3 epochs
This reproduces v7 config with Unsloth for 2x speed
NO "other" category data — 100% puzzle-focused
"""
...
try:
    ...
    try:
        ...
        wandb.init(project="nemotron-reasoning", name="sft-v22-v7data",
...
jsonl_paths = []
for pat in [
    "/kaggle/input/nemotron-training-v22/training_v22.jsonl",
    "/kaggle/input/datasets/bharatmohan/nemotron-training-v22/training_v22.jsonl",
    "/kaggle/input/*/training_v22.jsonl",
    "/kaggle/input/*/*/training_v22.jsonl",
    "/kaggle/input/*/*/*/training_v22.jsonl",
]:
...
if jsonl_paths:
    ...
    print("ERROR: training_v22.jsonl NOT FOUND")
    sys.exit(1)
...
print(f"\n{'='*60}")
print(f"SFT v22 — v7 data (504) + Unsloth + 3 epochs")
print(f"{'='*60}")
