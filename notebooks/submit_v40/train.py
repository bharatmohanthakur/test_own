...
- Takes Kaggle dataset bharatmohan/nemotron-v40-grpo-sft-adapter as input
...
candidates = []
for pat in [
    "/kaggle/input/nemotron-v40-grpo-sft-adapter",
    "/kaggle/input/datasets/bharatmohan/nemotron-v40-grpo-sft-adapter",
    "/kaggle/input/*/nemotron-v40-grpo-sft-adapter",
    "/kaggle/input/*",
    "/kaggle/input/*/*",
]:
