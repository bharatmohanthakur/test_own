"""
CPU-only submission wrapper for v32 GSPO adapter.
- Takes Kaggle dataset bharatmohan/nemotron-v32-gspo-adapter as input
...
candidates = []
for pat in [
    "/kaggle/input/nemotron-v32-gspo-adapter",
    "/kaggle/input/datasets/bharatmohan/nemotron-v32-gspo-adapter",
    "/kaggle/input/*/nemotron-v32-gspo-adapter",
    "/kaggle/input/*",
    "/kaggle/input/*/*",
]:
