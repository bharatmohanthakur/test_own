...
try:
    ...
    try:
        ...
        wandb.init(project="nemotron-reasoning", name="sft-v36-thk-binary-kh0a-targets",
...
jsonl_paths = []
for pat in [
    "/kaggle/input/nemotron-training-v36/training_v36.jsonl",
    "/kaggle/input/datasets/bharatmohan/nemotron-training-v36/training_v36.jsonl",
    "/kaggle/input/*/training_v36.jsonl",
    "/kaggle/input/*/*/training_v36.jsonl",
    "/kaggle/input/*/*/*/training_v36.jsonl",
]:
...
if jsonl_paths:
    ...
    print("ERROR: training_v36.jsonl NOT FOUND")
    sys.exit(1)
...
print(f"\n{'='*60}")
print(f"SFT v36 — v34c saturated (340) + v35 equation (13) + 50 THK-binary (403 total) + Kh0a 11-target config")
print(f"{'='*60}")
