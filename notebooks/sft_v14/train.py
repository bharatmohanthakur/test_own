"""
SFT v14 — mixed v11 TIR, 4096 context, runtime-aware
- Prefer combined_v11_tir.jsonl (22k mixed examples: puzzle + broad reasoning)
- Keep all broad-reasoning examples and sample the remainder to fit Kaggle runtime
- Expanded LoRA targets (all 9 module types)
- alpha=64, LR=1e-4, 2 epochs, max_seq=4096
...
try:
    ...
    wandb.init(project="nemotron-reasoning", name="sft-v14-mixed-4096",
        config={"method": "SFT-TIR", "lora_rank": 32, "lora_alpha": 64,
                "lr": 1e-4, "epochs": 2, "max_seq_len": 4096,
                "data": "mixed-v11-tir-capped", "targets": "9-modules",
                "max_examples": 12000},
        tags=["sft", "v14", "mixed", "4096"],
...
print(f"\n{'='*60}")
print(f"SFT v14 — alpha=64, mixed v11 TIR, 4096 context")
print(f"{'='*60}")
