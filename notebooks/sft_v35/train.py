...
try:
    ...
    try:
        ...
        wandb.init(project="nemotron-reasoning", name="sft-v35-equation-verifier",
...
jsonl_paths = []
for pat in [
    "/kaggle/input/nemotron-training-v35/training_v35.jsonl",
    "/kaggle/input/datasets/bharatmohan/nemotron-training-v35/training_v35.jsonl",
    "/kaggle/input/*/training_v35.jsonl",
    "/kaggle/input/*/*/training_v35.jsonl",
    "/kaggle/input/*/*/*/training_v35.jsonl",
]:
...
if jsonl_paths:
    ...
    print("ERROR: training_v35.jsonl NOT FOUND")
    sys.exit(1)
...
print(f"\n{'='*60}")
print(f"SFT v35 — v34c non-equation (390) + 13 verifier-derived equation (403 total)")
print(f"{'='*60}")
