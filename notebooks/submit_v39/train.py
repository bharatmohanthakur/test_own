...
- Takes Kaggle dataset bharatmohan/nemotron-sft-v39-adapter as input
...
candidates = []
for pat in [
    "/kaggle/input/nemotron-sft-v39-adapter",
    "/kaggle/input/datasets/bharatmohan/nemotron-sft-v39-adapter",
    "/kaggle/input/*/nemotron-sft-v39-adapter",
    "/kaggle/input/*",
    "/kaggle/input/*/*",
]:
