"""
SFT+GRPO v25 — Fixed torch.compile issue from v24
Phase 1: SFT with 504 verified examples
Phase 2: GRPO with 100 distilled examples
Fixes: unsloth_force_compile=False, is_fast_path patches, for_inference switch
"""
