"""
SFT+GRPO v24 — Two-phase training
Phase 1: SFT with 504 verified examples (custom loop, v7 config = 0.69)
Phase 2: GRPO with 100 distilled examples (difficulty-weighted)
"""
