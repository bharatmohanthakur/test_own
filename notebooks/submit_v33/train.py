"""
CPU-only submission wrapper for v33 GRPO adapter.
- Takes Kaggle dataset bharatmohan/nemotron-v33-grpo-donald-adapter as input
...
candidates = []
for pat in [
    "/kaggle/input/nemotron-v33-grpo-donald-adapter",
    "/kaggle/input/datasets/bharatmohan/nemotron-v33-grpo-donald-adapter",
    "/kaggle/input/*/nemotron-v33-grpo-donald-adapter",
    "/kaggle/input/*",
    "/kaggle/input/*/*",
]:
