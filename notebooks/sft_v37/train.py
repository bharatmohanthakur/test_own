...
try:
    ...
    try:
        ...
        wandb.init(project="nemotron-reasoning", name="sft-v37-kh0a-data-kh0a-config",
...
jsonl_paths = []
for pat in [
    "/kaggle/input/nemotron-training-v37/training_v37.jsonl",
    "/kaggle/input/datasets/bharatmohan/nemotron-training-v37/training_v37.jsonl",
    "/kaggle/input/*/training_v37.jsonl",
    "/kaggle/input/*/*/training_v37.jsonl",
    "/kaggle/input/*/*/*/training_v37.jsonl",
]:
...
if jsonl_paths:
    ...
    print("ERROR: training_v37.jsonl NOT FOUND")
    sys.exit(1)
...
trainer = SFTTrainer(
    ...
    args=TrainingArguments(
        ...
        weight_decay=0.01,
        max_grad_norm=1.0,
        gradient_checkpointing=False,  # Kh0a 0.73 — OFF for speed
    ),
    max_seq_length=MAX_SEQ_LEN,
...
# Note: Kh0a does NOT use train_on_responses_only — trains on full sequence

print(f"\n{'='*60}")
print(f"SFT v37 — Kh0a 3910 training examples + Kh0a exact config (r32 a16 d0.1 LR1e-4 b2 ga1 seq3500 e2)")
print(f"{'='*60}")
