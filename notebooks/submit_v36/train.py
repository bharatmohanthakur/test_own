...
- Takes Kaggle dataset bharatmohan/nemotron-v36-sft-adapter as input
...
candidates = []
for pat in [
    "/kaggle/input/nemotron-v36-sft-adapter",
    "/kaggle/input/datasets/bharatmohan/nemotron-v36-sft-adapter",
    "/kaggle/input/*/nemotron-v36-sft-adapter",
    "/kaggle/input/*",
    "/kaggle/input/*/*",
]:
