"""
SFT v20 — Unsloth 16-bit LoRA + v7 proven hyperparams
1699 curated examples, 2 epochs, alpha=64, LR=2e-4
v7 scored 0.69 — only change is Unsloth for speed
"""
...
try:
    ...
    try:
        ...
        wandb.init(project="nemotron-reasoning", name="sft-v20-unsloth",
...
if jsonl_paths:
    ...
    print("ERROR: training_v18.jsonl NOT FOUND")
    sys.exit(1)
...
print(f"\n{'='*60}")
print(f"SFT v20 — Unsloth 16-bit LoRA")
print(f"{'='*60}")
