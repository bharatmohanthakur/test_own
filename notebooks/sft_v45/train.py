...
try:
    ...
    try:
        ...
        wandb.init(project="nemotron-reasoning", name="sft-v45-lr5e5",
...
jsonl_paths = []
for pat in [
    "/kaggle/input/nemotron-training-v38/training_v38.jsonl",
    "/kaggle/input/datasets/bharatmohan/nemotron-training-v38/training_v38.jsonl",
    "/kaggle/input/*/training_v38.jsonl",
    "/kaggle/input/*/*/training_v38.jsonl",
    "/kaggle/input/*/*/*/training_v38.jsonl",
]:
...
if jsonl_paths:
    ...
    print("ERROR: training_v38.jsonl NOT FOUND")
    sys.exit(1)
...
print(f"\n{'='*60}")
print(f"SFT v38 — 1131 THK-sequence binary + 1550 Kh0a non-binary (2681 total) + Kh0a config")
print(f"{'='*60}")
